// This is what is called "second try" in $5.1 in the book.  It
// removes the students who fail from the structure "students" and
// puts the students who fail in the "fail" structure
