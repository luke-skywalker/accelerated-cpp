// This is what is called "third try" in $5.3 in the book.  It removes
// the students who fail from the structure "students" and puts the
// students who fail in the "fail" structure. It does so using
