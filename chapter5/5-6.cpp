// Exercise 5-6. Compare with 5-2_vec_2
...
std::vector<Student_info> extract_fails(std::vector<Student_info>& students)
{
  ...
  std::vector<Student_info>::size_type i = 0, j = 0;

  // invariant: elements [0, i) of students represent passing grades
  // j students have passed
  ...
  for (i = 0; i != students.size(); ++i) {
    if (fgrade(students[i]))
      ...
      ++i; // this one is because we added an element at the beginning of students!
      ++j; // keeps count of how many students passed
    }
  }
